...
# --- NUEVO: Definir carpeta de salida ---
OUTPUT_DIR = 'results'
...
if __name__ == "__main__":
    ...
    # --- NUEVO: Crear la carpeta de salida si no existe ---
    ...
    # ... (Todo el código de las Fases 1 y 2 no cambia) ...
    ...
    # --- PROCESAMIENTO FINAL (sin cambios) ---
    ...
    # --- VISUALIZACIÓN 2x2 (sin cambios en la lógica de graficación) ---
    ...
    # --- NUEVO: Guardar la figura en un archivo ---
    # Extraer el nombre base del archivo de entrada para crear un nombre de salida único
    base_name = os.path.splitext(FILE_NAME)[0]
    output_filename = f"{base_name}_analysis.png"
    output_path = os.path.join(OUTPUT_DIR, output_filename)
    
    # Guardar la figura con buena resolución (dpi)
    plt.savefig(output_path, dpi=300)
    print(f"\n Gráfica guardada exitosamente en: {output_path}")

    # Mostrar la figura en pantalla como antes
    plt.show()